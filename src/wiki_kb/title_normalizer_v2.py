...
class TitleNormalizer:
    def __init__(self, lang="en", redirect_map=None, t2id=None, id2t=None, redirect_set=None,date='20190701', prep_lower2upper=False):
        if t2id is None:
            id2t, t2id, redirect_set = load_id2title_mongo('data/{}wiki/idmap/{}wiki-{}.id2t'.format(lang,lang,date), '/pool0/webserver/incoming/experiment_tmp/EDL2019/data/outdir/{}wiki/idmap/{}wiki-{}.id2t'.format(lang,lang,date))
        if redirect_map is None:
            redirect_map = load_redirects_mongo('data/{}wiki/idmap/{}wiki-{}.r2t'.format(lang,lang,date),  '/pool0/webserver/incoming/experiment_tmp/EDL2019/data/outdir/{}wiki/idmap/{}wiki-{}.r2t'.format(lang,lang,date))
        self.null_counts = 0
        self.call_counts = 0
        self.lang = lang
